...
rule cutadapt:
    ...
    params:
        adapters ="-g CTACGGGNGGCWG -G GACTACHVGGG", #long forward primer is CTACGGGNGGCWGCAG; long reverse primer is GACTACHVGGGGTATCTAATCC 
        extra = "--discard-untrimmed"
    log:
        config["path"] + "QC/{sample_id}.log"
    wrapper:
        "file:///PUBLIC_DATA/Microbiology/snakemake-wrappers/bio/cutadapt/pe"
rule QC:
